    ...
    if turno % 2 != 0:
        ...
        if es_perdedor == True:
            ...
            if que_hacer == "1":#Dos ciclos, una para que lo ingreso correctamente y otro para que sea "X" o solo 1 con or
                ...
                # Es un true o un false ---> para ver si esta bien escrito
                corresponde = es_x(tablero_juego,fila_seleccion,columna_seleccion)
                #print("Corresponde",corresponde)#Retorna True si corresponde con una X
                se_puede_mover = quedan_movimientos(tablero_juego,fila_seleccion, columna_seleccion)#Deberia retornar True si al menos le queda 1 mov
                print("se puede mover, True si puede ---->", se_puede_mover)
                ...
                while revisar_seleccion == False or corresponde == False or se_puede_mover == False:
                    print("")#Ahora el ciclo esta bien
                    #Ya estamos revisando si esta bien escrita o si es X
                    #Falta si puede mover la ficha
                ...
                if revisar_seleccion == True and corresponde ==True:
                    fila_seleccion = cambiar_fila(seleccion)
                    columna_seleccion = cambiar_columna(seleccion)
...
Habria que verificar si hay perdedor en mas de una parte!
Despues de cada input
"""
