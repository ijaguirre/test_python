#Se recomienda ejecutar el juego en IDLES como PyCharm o www.replit.com o Python Command Line o Python IDLE por Linux
import os

def saludo():
    print("Se recomienda ejecutar el juego en IDLES como PyCharm o www.replit.com o Python Command Line o Python IDLE por Linux")
    print("")
    print("")
