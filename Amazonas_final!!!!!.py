...
puede_iniciar_2 = perdedor_inicio(tablero_juego,2)#Ninguno parte perdiendo, si sale False es que ninguno ha perdido, si alguno sale verdadero ese perdio
            ...
            if que_hacer == "1":#Dos ciclos, una para que lo ingreso correctamente y otro para que sea "X" o solo 1 con or
                ...
                if corresponde == True and revisar_seleccion ==True and se_puede_mover == True:
                    ...
                    if mov_licito == True and bien_escrita ==True:
                        ...
                        #Parte flecha
                        flecha = input("Ingrese donde quiere que vaya la flecha: ")#Hay que revisar si se pierde antes de pasar al otro!
                        flecha = flecha.lower()
